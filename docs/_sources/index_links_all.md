...
:::{literalinclude} examples/test.md
:::

embed dots 
```{embed} examples/test.md#cool_text
```
...
include 1
:::{include} examples/test.md
:::

include 1.2
:::{include} 03_images/test.md
:::
...
{ref}`examples/test.md#cool_text`


:::{figure} /videos/MTMtgoats.mp4
