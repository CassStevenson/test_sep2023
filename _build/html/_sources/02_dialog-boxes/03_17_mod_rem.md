...
). If animals behave like ideal gas particles, the rate at which they “bump into” and trigger camera traps is a function of animal movement, population density and the area within which cameras detect animals ({{ ref_intext_nakashima_et_al_2018 }}). So, the more animals move, the more animals in a population, or the larger the viewshed – the more images will be captured ({{ ref_intext_palencia_2022 }}). This relationship can be used to estimate density, such that: 
